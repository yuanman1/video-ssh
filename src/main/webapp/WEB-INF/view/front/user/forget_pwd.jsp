...
<body>
    ...
    <main>
        <div class="container">
            <form class="ma" action="front4/user_userreset_pwd.action" method="post" id="formId">
                <div class="form_header">
                    ...
                    <div class="form_back">
                        <a href="front2/user_tuichu.action">返回立即登录</a>
                    </div>
                </div>
                <div class="form_body">
                ...
                <div class="form_footer">
                    <div class="FAQ">
                        <span>收不到邮件？查看</span><a href="https://www.baidu.com/">常见问题</a>
                    </div>
                </div>
            </form>
        </div>
...
<%@include file="../include/script.html"%>
    <script type="text/javascript">
		function submitEmail(){
			...
			//改为ajax提交邮箱
			if(email!=null&&email!=''){
				$.post('front1/user_sendemail.action',{email:email},function(data){
					console.log(data);
					if(data.success){
