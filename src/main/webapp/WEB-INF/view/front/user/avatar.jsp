        ...
        <div class="container">
            ...
            <div id="profile_tab">
               <ul class="profile_tab_header f_left clearfix">
                    <li><a href="front4/user_userprofile.action">更改资料</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="front4/user_useravatar.action">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="front4/user_userpassword.action">密码安全</a></li>
                </ul>
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <div class="profile_ifo_area">
                            <form id="upload_form" enctype="multipart/form-data" method="post" action="front4/user_useravatar1.action" >
                                <p>请选择图像文件</p>
                                <div>
