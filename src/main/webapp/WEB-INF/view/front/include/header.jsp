	...
	<div class="container">
		...
		<c:if test="${not empty _front_user}">
			<div id="userBlock" style="float:right">
				<a href="front2/user_logout.action">退出</a>
				<a href="front3/user.action" id="account">${_front_user.email }</a>
			</div>
		</c:if>
		...
		<a target="_blank" href="admin/user_login.action"><img src="static/img/we.png" draggable="false">后台管理</a>
