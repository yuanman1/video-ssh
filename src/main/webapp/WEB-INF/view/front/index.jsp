        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="frontcourse/course.action?subject_id=1">
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="frontcourse/course.action?subject_id=6">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <a href="frontcourse/course.action?subject_id=10">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="frontcourse/course.action?subject_id=11">
